...
class WebSocketWrapper {
    ...
    _setupActions(websocketServer) {
        ...
        websocketServer.on('connection', (wsClient, clientHttpGetReq) => {
            ...
            // Assign unique ID for websocket client via headers or query parameters
            const sessionId = Url.parse(clientHttpGetReq.url, true).query.session_id ||
                clientHttpGetReq.headers['session_id'];
